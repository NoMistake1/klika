...
export const seatingZones: readonly SeatingZone[] = [
  {
    ...
    image: {
      src: "/images/restaurant/zone-restaurant.png",
      alt: {
        cs: "Zástupný obrázek vnitřní restaurace s původní hradbou",
        en: "Placeholder image of the indoor restaurant with the original wall",
        de: "Platzhalterbild des Innenraums mit der ursprünglichen Mauer",
      },
      width: 1400,
      height: 1050,
      isPlaceholder: true,
  ...
  },
  {
    ...
    image: {
      src: "/images/restaurant/zone-conservatory.png",
      alt: {
        cs: "Zástupný obrázek skleníku s výhledem na řeku",
        en: "Placeholder image of the conservatory with a river view",
        de: "Platzhalterbild des Wintergartens mit Blick auf den Fluss",
      },
      width: 1400,
      height: 1050,
      isPlaceholder: true,
  ...
  },
  {
    ...
    image: {
      src: "/images/restaurant/zone-garden.png",
      alt: {
        cs: "Zástupný obrázek zahrádky u řeky",
        en: "Placeholder image of the riverside garden",
        de: "Platzhalterbild des Gartens am Fluss",
      },
      width: 1400,
      height: 1050,
      isPlaceholder: true,
