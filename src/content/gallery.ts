...
export const galleryItems: readonly GalleryItem[] = [
  ...
  },
  {
    ...
    image: {
      ...
      alt: {
        cs: "Zástupný obrázek — dvoulůžkový pokoj",
        en: "Placeholder image — the double room",
        de: "Platzhalterbild — Doppelzimmer",
      },
      width: 1600,
      height: 1200,
      isPlaceholder: true,
  ...
  },
  {
    ...
    image: {
      ...
      alt: {
        cs: "Zástupný obrázek — třílůžkový pokoj",
        en: "Placeholder image — the triple room",
        de: "Platzhalterbild — Dreibettzimmer",
      },
      width: 1600,
      height: 1200,
      isPlaceholder: true,
  ...
  },
  {
    ...
    image: {
      ...
      alt: {
        cs: "Zástupný obrázek — interiér s původní hradbou",
        en: "Placeholder image — the interior with the original wall",
        de: "Platzhalterbild — Innenraum mit der ursprünglichen Mauer",
      },
      width: 1400,
      height: 1050,
      isPlaceholder: true,
  ...
  },
  {
    ...
    image: {
      ...
      alt: {
        cs: "Zástupný obrázek — zahrádka u řeky",
        en: "Placeholder image — the riverside garden",
        de: "Platzhalterbild — Garten am Fluss",
      },
      width: 1400,
      height: 1050,
      isPlaceholder: true,
